...
<jsp:useBean id="bb" scope="page" class="model2.ch12.Bank1Bean"></jsp:useBean>
<jsp:useBean id="bb2" scope="page" class="model2.ch12.Bank2Bean"></jsp:useBean>
<%
	if(request.getMethod().equals("POST")){
		if(bb.transfer(Integer.parseInt(request.getParameter("bal")))){
			out.println("<script> alert('정상처리 되었습니다')</script>");
		}else{
			out.println("<script> alert('이체가 실패했습니다.')</script>");
		}
	       }
		bb.getData();
		bb2.getData();
