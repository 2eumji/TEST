...
public class ButtonTest2 {
	public static void main(String[] args) {
		...
		f.setBounds(100,100,500,500); //오픈위치,크기 설정
		f.setLayout(new FlowLayout());//정렬
		...
		//종료이벤트 addWindowListener (시스템 메인안)
	...
	static ActionListener al=new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getActionCommand().equals("1")) {
				...
				System.out.println("2번누름");
			}else if(e.getActionCommand().equals("3")) {
				System.out.println("3번누름");
			}else if(e.getActionCommand().equals("4")) {
				System.out.println("4번누름");
			}
			System.out.println("=======================");
		}
	};
